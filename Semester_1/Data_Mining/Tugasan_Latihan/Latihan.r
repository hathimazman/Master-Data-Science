Nama Ahli Kumpulan
1. Luqman Arif bin Zulkarnain (P153125)
2. Ahmad Hathim bin Ahmad Azman (P153146)
3. Muhammad Khalid Bin Noor Ashani (P146854)
4. Muhammad Zuhair Afham Bin Mohd Nasir (P153944)
5. Ahmad Nazmi bin Zayuri (P146217)
6. Hazim Fitri Bin Ahmad Faudzi (P152419)
====================
#1. Cipta Vektor
...
data_sorted = data2[order(data2$PendapatanBulanan, decreasing = FALSE),]
